                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td width="64" valign="middle" style="padding-right:16px;">
                      <div style="display:inline-block; width:56px; height:56px; border-radius:50%; border:4px solid #22c55e; text-align:center; line-height:1;">
                        <span style="font-family:${B.fontHeading}; font-size:22px; font-weight:900; color:#22c55e; display:block; padding-top:10px; line-height:1;">68</span>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td class="pad-mobile" style="padding: 8px 44px 0;">
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
            ${featureItem("scan", "Scans illimit&eacute;s", "Repass&eacute; &agrave; 15 scans/jour en mode gratuit.")}
...
CE QUE TU PERDS DANS 48H :
- Scans illimités → repassé à 15 scans/jour
                  ...
                  <tr>
                    <td style="padding:20px 16px;">
                      ...
                      <p style="margin:0 0 8px; font-family:${B.fontBody}; font-size:13px; color:${B.textSecondary}; line-height:22px;">
                        <span style="color:${B.textMuted};">&#10003;</span> 15 scans / jour
                      </p>
                      <p style="margin:0 0 8px; font-family:${B.fontBody}; font-size:13px; color:${B.textSecondary}; line-height:22px;">
