-- Migration: ingredient_rulings table
-- Context-aware halal rulings for ingredient detection engine v4
...
CREATE INDEX IF NOT EXISTS "ingredient_rulings_priority_idx"
  ON "ingredient_rulings" ("priority");
CREATE INDEX IF NOT EXISTS "ingredient_rulings_category_idx"
  ON "ingredient_rulings" ("category");
CREATE INDEX IF NOT EXISTS "ingredient_rulings_active_idx"
  ON "ingredient_rulings" ("is_active");
